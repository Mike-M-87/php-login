...
if (isset($_POST['vie-submit'])) {
    ...
    echo "user", $user_id, " elec", $election_id, " pos", $position_id;
    ...
    // $sql = "SELECT * FROM candidate WHERE id = '$user_id' AND election_id = '$election_id' ";
    $sql = "SELECT * FROM candidate WHERE id = '$user_id' ";
    ...
    if ($row > 0) {
        ...
        $sql = "INSERT INTO candidate (id,position_id, election_id) VALUES($user_id,$position_id,$election_id)";
